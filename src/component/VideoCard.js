    ...
    return (
        <>
            <div className="m-6  lg:flex">
                <div className="h-48 lg:h-auto lg:w-56 flex bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center" style={{ backgroundImage: `url(${videodata.thumbnails.high.url})` }}></div>
